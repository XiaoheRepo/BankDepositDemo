...
public interface InterestSettlementMapper {
    ...
    @Insert("INSERT INTO interest_settlement (account_id, currency, settlement_date, accumulated_amount, " +
            "applied_rate, interest_days, interest_amount, trans_id) " +
            "VALUES (#{accountId}, #{currency}, #{settlementDate}, #{accumulatedAmount}, #{appliedRate}, " +
